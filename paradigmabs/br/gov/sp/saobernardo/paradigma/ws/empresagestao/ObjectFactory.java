 ...
 * generated in the br.gov.sp.saobernardo.paradigma.ws.empresagestao package. 
...
public class ObjectFactory {
    ...
    private final static QName _ArrayOfEmpresaGestaoDTO_QNAME = new QName("http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", "ArrayOfEmpresaGestaoDTO");
    ...
    private final static QName _EmpresaGestaoDTO_QNAME = new QName("http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", "EmpresaGestaoDTO");
    ...
    private final static QName _ProcessarEmpresaGestaoLstEmpresaGestao_QNAME = new QName("http://tempuri.org/", "lstEmpresaGestao");
    private final static QName _EmpresaGestaoDTOSCdGestao_QNAME = new QName("http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", "sCdGestao");
    private final static QName _EmpresaGestaoDTOSCdEmpresa_QNAME = new QName("http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", "sCdEmpresa");
    private final static QName _ProcessarEmpresaGestaoResponseProcessarEmpresaGestaoResult_QNAME = new QName("http://tempuri.org/", "ProcessarEmpresaGestaoResult");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.gov.sp.saobernardo.paradigma.ws.empresagestao
     * 
     */
    ...
    /**
     * Create an instance of {@link ProcessarEmpresaGestao }
     * 
     */
    public ProcessarEmpresaGestao createProcessarEmpresaGestao() {
        return new ProcessarEmpresaGestao();
    }
    ...
    /**
     * Create an instance of {@link ArrayOfEmpresaGestaoDTO }
     * 
     */
    public ArrayOfEmpresaGestaoDTO createArrayOfEmpresaGestaoDTO() {
        return new ArrayOfEmpresaGestaoDTO();
    }

    /**
     * Create an instance of {@link EmpresaGestaoDTO }
     * 
     */
    public EmpresaGestaoDTO createEmpresaGestaoDTO() {
        return new EmpresaGestaoDTO();
    }
    ...
    /**
     * Create an instance of {@link ProcessarEmpresaGestaoResponse }
     * 
     */
    public ProcessarEmpresaGestaoResponse createProcessarEmpresaGestaoResponse() {
        return new ProcessarEmpresaGestaoResponse();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ArrayOfEmpresaGestaoDTO }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", name = "ArrayOfEmpresaGestaoDTO")
    public JAXBElement<ArrayOfEmpresaGestaoDTO> createArrayOfEmpresaGestaoDTO(ArrayOfEmpresaGestaoDTO value) {
        return new JAXBElement<ArrayOfEmpresaGestaoDTO>(_ArrayOfEmpresaGestaoDTO_QNAME, ArrayOfEmpresaGestaoDTO.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link EmpresaGestaoDTO }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", name = "EmpresaGestaoDTO")
    public JAXBElement<EmpresaGestaoDTO> createEmpresaGestaoDTO(EmpresaGestaoDTO value) {
        return new JAXBElement<EmpresaGestaoDTO>(_EmpresaGestaoDTO_QNAME, EmpresaGestaoDTO.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "lstEmpresaGestao", scope = ProcessarEmpresaGestao.class)
    public JAXBElement<ArrayOfEmpresaGestaoDTO> createProcessarEmpresaGestaoLstEmpresaGestao(ArrayOfEmpresaGestaoDTO value) {
        return new JAXBElement<ArrayOfEmpresaGestaoDTO>(_ProcessarEmpresaGestaoLstEmpresaGestao_QNAME, ArrayOfEmpresaGestaoDTO.class, ProcessarEmpresaGestao.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", name = "sCdGestao", scope = EmpresaGestaoDTO.class)
    public JAXBElement<String> createEmpresaGestaoDTOSCdGestao(String value) {
        return new JAXBElement<String>(_EmpresaGestaoDTOSCdGestao_QNAME, String.class, EmpresaGestaoDTO.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", name = "sCdEmpresa", scope = EmpresaGestaoDTO.class)
    public JAXBElement<String> createEmpresaGestaoDTOSCdEmpresa(String value) {
        return new JAXBElement<String>(_EmpresaGestaoDTOSCdEmpresa_QNAME, String.class, EmpresaGestaoDTO.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "ProcessarEmpresaGestaoResult", scope = ProcessarEmpresaGestaoResponse.class)
    public JAXBElement<RetornoDTO> createProcessarEmpresaGestaoResponseProcessarEmpresaGestaoResult(RetornoDTO value) {
        return new JAXBElement<RetornoDTO>(_ProcessarEmpresaGestaoResponseProcessarEmpresaGestaoResult_QNAME, RetornoDTO.class, ProcessarEmpresaGestaoResponse.class, value);
    }

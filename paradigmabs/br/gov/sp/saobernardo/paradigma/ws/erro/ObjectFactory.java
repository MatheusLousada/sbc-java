 ...
 * generated in the br.gov.sp.saobernardo.paradigma.ws.erro package. 
...
public class ObjectFactory {
    ...
    private final static QName _RetornarErroResponseRetornarErroResult_QNAME = new QName("http://tempuri.org/", "RetornarErroResult");
    ...
    private final static QName _RetornarLogSNrToken_QNAME = new QName("http://tempuri.org/", "sNrToken");
    ...
    private final static QName _RetornarSucessoResponseRetornarSucessoResult_QNAME = new QName("http://tempuri.org/", "RetornarSucessoResult");
    private final static QName _ProcessarErroSDsLogDetalhado_QNAME = new QName("http://tempuri.org/", "sDsLogDetalhado");
    private final static QName _ProcessarErroSDsLog_QNAME = new QName("http://tempuri.org/", "sDsLog");
    private final static QName _RetornarLogResponseRetornarLogResult_QNAME = new QName("http://tempuri.org/", "RetornarLogResult");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.gov.sp.saobernardo.paradigma.ws.erro
     * 
     */
    ...
    /**
     * Create an instance of {@link RetornarErroResponse }
     * 
     */
    public RetornarErroResponse createRetornarErroResponse() {
        return new RetornarErroResponse();
    }

    /**
     * Create an instance of {@link RetornarLog }
     * 
     */
    public RetornarLog createRetornarLog() {
        return new RetornarLog();
    }

    /**
     * Create an instance of {@link RetornarSucesso }
     * 
     */
    public RetornarSucesso createRetornarSucesso() {
        return new RetornarSucesso();
    }

    /**
     * Create an instance of {@link RetornarErro }
     * 
     */
    public RetornarErro createRetornarErro() {
        return new RetornarErro();
    }
    ...
    /**
     * Create an instance of {@link ProcessarErroResponse }
     * 
     */
    public ProcessarErroResponse createProcessarErroResponse() {
        return new ProcessarErroResponse();
    }

    /**
     * Create an instance of {@link RetornarSucessoResponse }
     * 
     */
    public RetornarSucessoResponse createRetornarSucessoResponse() {
        return new RetornarSucessoResponse();
    }
    ...
    /**
     * Create an instance of {@link ProcessarErro }
     * 
     */
    public ProcessarErro createProcessarErro() {
        return new ProcessarErro();
    }

    /**
     * Create an instance of {@link RetornarLogResponse }
     * 
     */
    public RetornarLogResponse createRetornarLogResponse() {
        return new RetornarLogResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "RetornarErroResult", scope = RetornarErroResponse.class)
    public JAXBElement<RetornoDTO> createRetornarErroResponseRetornarErroResult(RetornoDTO value) {
        return new JAXBElement<RetornoDTO>(_RetornarErroResponseRetornarErroResult_QNAME, RetornoDTO.class, RetornarErroResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "sNrToken", scope = RetornarLog.class)
    public JAXBElement<String> createRetornarLogSNrToken(String value) {
        return new JAXBElement<String>(_RetornarLogSNrToken_QNAME, String.class, RetornarLog.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "sNrToken", scope = RetornarSucesso.class)
    public JAXBElement<String> createRetornarSucessoSNrToken(String value) {
        return new JAXBElement<String>(_RetornarLogSNrToken_QNAME, String.class, RetornarSucesso.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "sNrToken", scope = RetornarErro.class)
    public JAXBElement<String> createRetornarErroSNrToken(String value) {
        return new JAXBElement<String>(_RetornarLogSNrToken_QNAME, String.class, RetornarErro.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "RetornarSucessoResult", scope = RetornarSucessoResponse.class)
    public JAXBElement<RetornoDTO> createRetornarSucessoResponseRetornarSucessoResult(RetornoDTO value) {
        return new JAXBElement<RetornoDTO>(_RetornarSucessoResponseRetornarSucessoResult_QNAME, RetornoDTO.class, RetornarSucessoResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "sDsLogDetalhado", scope = ProcessarErro.class)
    public JAXBElement<String> createProcessarErroSDsLogDetalhado(String value) {
        return new JAXBElement<String>(_ProcessarErroSDsLogDetalhado_QNAME, String.class, ProcessarErro.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "sDsLog", scope = ProcessarErro.class)
    public JAXBElement<String> createProcessarErroSDsLog(String value) {
        return new JAXBElement<String>(_ProcessarErroSDsLog_QNAME, String.class, ProcessarErro.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "RetornarLogResult", scope = RetornarLogResponse.class)
    public JAXBElement<RetornoDTO> createRetornarLogResponseRetornarLogResult(RetornoDTO value) {
        return new JAXBElement<RetornoDTO>(_RetornarLogResponseRetornarLogResult_QNAME, RetornoDTO.class, RetornarLogResponse.class, value);
    }

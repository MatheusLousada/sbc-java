 ...
 * generated in the br.gov.sp.saobernardo.paradigma.ws.produtocomprahistorico package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProdutoCompraHistoricoDTO_QNAME = new QName("http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", "ProdutoCompraHistoricoDTO");
    ...
    private final static QName _ArrayOfProdutoCompraHistoricoDTO_QNAME = new QName("http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", "ArrayOfProdutoCompraHistoricoDTO");
    ...
    private final static QName _ProcessarUltimaCompraHistoricoResponseProcessarUltimaCompraHistoricoResult_QNAME = new QName("http://tempuri.org/", "ProcessarUltimaCompraHistoricoResult");
    private final static QName _ProcessarUltimaCompraHistoricoLstProdutoCompraHistorico_QNAME = new QName("http://tempuri.org/", "lstProdutoCompraHistorico");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.gov.sp.saobernardo.paradigma.ws.produtocomprahistorico
     * 
     */
    ...
    /**
     * Create an instance of {@link ArrayOfProdutoCompraHistoricoDTO }
     * 
     */
    public ArrayOfProdutoCompraHistoricoDTO createArrayOfProdutoCompraHistoricoDTO() {
        return new ArrayOfProdutoCompraHistoricoDTO();
    }

    /**
     * Create an instance of {@link ProcessarUltimaCompraHistoricoResponse }
     * 
     */
    public ProcessarUltimaCompraHistoricoResponse createProcessarUltimaCompraHistoricoResponse() {
        return new ProcessarUltimaCompraHistoricoResponse();
    }
    ...
    /**
     * Create an instance of {@link ProdutoCompraHistoricoDTO }
     * 
     */
    public ProdutoCompraHistoricoDTO createProdutoCompraHistoricoDTO() {
        return new ProdutoCompraHistoricoDTO();
    }

    /**
     * Create an instance of {@link ProcessarUltimaCompraHistorico }
     * 
     */
    public ProcessarUltimaCompraHistorico createProcessarUltimaCompraHistorico() {
        return new ProcessarUltimaCompraHistorico();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ProdutoCompraHistoricoDTO }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", name = "ProdutoCompraHistoricoDTO")
    public JAXBElement<ProdutoCompraHistoricoDTO> createProdutoCompraHistoricoDTO(ProdutoCompraHistoricoDTO value) {
        return new JAXBElement<ProdutoCompraHistoricoDTO>(_ProdutoCompraHistoricoDTO_QNAME, ProdutoCompraHistoricoDTO.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ArrayOfProdutoCompraHistoricoDTO }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", name = "ArrayOfProdutoCompraHistoricoDTO")
    public JAXBElement<ArrayOfProdutoCompraHistoricoDTO> createArrayOfProdutoCompraHistoricoDTO(ArrayOfProdutoCompraHistoricoDTO value) {
        return new JAXBElement<ArrayOfProdutoCompraHistoricoDTO>(_ArrayOfProdutoCompraHistoricoDTO_QNAME, ArrayOfProdutoCompraHistoricoDTO.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "ProcessarUltimaCompraHistoricoResult", scope = ProcessarUltimaCompraHistoricoResponse.class)
    public JAXBElement<RetornoDTO> createProcessarUltimaCompraHistoricoResponseProcessarUltimaCompraHistoricoResult(RetornoDTO value) {
        return new JAXBElement<RetornoDTO>(_ProcessarUltimaCompraHistoricoResponseProcessarUltimaCompraHistoricoResult_QNAME, RetornoDTO.class, ProcessarUltimaCompraHistoricoResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "lstProdutoCompraHistorico", scope = ProcessarUltimaCompraHistorico.class)
    public JAXBElement<ArrayOfProdutoCompraHistoricoDTO> createProcessarUltimaCompraHistoricoLstProdutoCompraHistorico(ArrayOfProdutoCompraHistoricoDTO value) {
        return new JAXBElement<ArrayOfProdutoCompraHistoricoDTO>(_ProcessarUltimaCompraHistoricoLstProdutoCompraHistorico_QNAME, ArrayOfProdutoCompraHistoricoDTO.class, ProcessarUltimaCompraHistorico.class, value);
    }

 ...
 * generated in the br.gov.sp.saobernardo.paradigma.ws.moedacotacao package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProcessarMoedaCotacaoLstMoedaCotacao_QNAME = new QName("http://tempuri.org/", "lstMoedaCotacao");
    ...
    private final static QName _MoedaCotacaoDTO_QNAME = new QName("http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", "MoedaCotacaoDTO");
    private final static QName _ArrayOfMoedaCotacaoDTO_QNAME = new QName("http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", "ArrayOfMoedaCotacaoDTO");
    ...
    private final static QName _ProcessarMoedaCotacaoResponseProcessarMoedaCotacaoResult_QNAME = new QName("http://tempuri.org/", "ProcessarMoedaCotacaoResult");
    ...
    private final static QName _MoedaCotacaoDTOSCdMoedaOrigem_QNAME = new QName("http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", "sCdMoedaOrigem");
    private final static QName _MoedaCotacaoDTOSCdMoedaDestino_QNAME = new QName("http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", "sCdMoedaDestino");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.gov.sp.saobernardo.paradigma.ws.moedacotacao
     * 
     */
    ...
    /**
     * Create an instance of {@link ProcessarMoedaCotacao }
     * 
     */
    public ProcessarMoedaCotacao createProcessarMoedaCotacao() {
        return new ProcessarMoedaCotacao();
    }

    /**
     * Create an instance of {@link ProcessarMoedaCotacaoResponse }
     * 
     */
    public ProcessarMoedaCotacaoResponse createProcessarMoedaCotacaoResponse() {
        return new ProcessarMoedaCotacaoResponse();
    }
    ...
    /**
     * Create an instance of {@link ArrayOfMoedaCotacaoDTO }
     * 
     */
    public ArrayOfMoedaCotacaoDTO createArrayOfMoedaCotacaoDTO() {
        return new ArrayOfMoedaCotacaoDTO();
    }

    /**
     * Create an instance of {@link MoedaCotacaoDTO }
     * 
     */
    public MoedaCotacaoDTO createMoedaCotacaoDTO() {
        return new MoedaCotacaoDTO();
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ArrayOfMoedaCotacaoDTO }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "lstMoedaCotacao", scope = ProcessarMoedaCotacao.class)
    public JAXBElement<ArrayOfMoedaCotacaoDTO> createProcessarMoedaCotacaoLstMoedaCotacao(ArrayOfMoedaCotacaoDTO value) {
        return new JAXBElement<ArrayOfMoedaCotacaoDTO>(_ProcessarMoedaCotacaoLstMoedaCotacao_QNAME, ArrayOfMoedaCotacaoDTO.class, ProcessarMoedaCotacao.class, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link MoedaCotacaoDTO }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", name = "MoedaCotacaoDTO")
    public JAXBElement<MoedaCotacaoDTO> createMoedaCotacaoDTO(MoedaCotacaoDTO value) {
        return new JAXBElement<MoedaCotacaoDTO>(_MoedaCotacaoDTO_QNAME, MoedaCotacaoDTO.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", name = "ArrayOfMoedaCotacaoDTO")
    public JAXBElement<ArrayOfMoedaCotacaoDTO> createArrayOfMoedaCotacaoDTO(ArrayOfMoedaCotacaoDTO value) {
        return new JAXBElement<ArrayOfMoedaCotacaoDTO>(_ArrayOfMoedaCotacaoDTO_QNAME, ArrayOfMoedaCotacaoDTO.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "ProcessarMoedaCotacaoResult", scope = ProcessarMoedaCotacaoResponse.class)
    public JAXBElement<RetornoDTO> createProcessarMoedaCotacaoResponseProcessarMoedaCotacaoResult(RetornoDTO value) {
        return new JAXBElement<RetornoDTO>(_ProcessarMoedaCotacaoResponseProcessarMoedaCotacaoResult_QNAME, RetornoDTO.class, ProcessarMoedaCotacaoResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", name = "sCdMoedaOrigem", scope = MoedaCotacaoDTO.class)
    public JAXBElement<String> createMoedaCotacaoDTOSCdMoedaOrigem(String value) {
        return new JAXBElement<String>(_MoedaCotacaoDTOSCdMoedaOrigem_QNAME, String.class, MoedaCotacaoDTO.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/Paradigma.Wbc.Servico.DTO", name = "sCdMoedaDestino", scope = MoedaCotacaoDTO.class)
    public JAXBElement<String> createMoedaCotacaoDTOSCdMoedaDestino(String value) {
        return new JAXBElement<String>(_MoedaCotacaoDTOSCdMoedaDestino_QNAME, String.class, MoedaCotacaoDTO.class, value);
    }

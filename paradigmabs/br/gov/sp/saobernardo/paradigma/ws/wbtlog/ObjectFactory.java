 ...
 * generated in the br.gov.sp.saobernardo.paradigma.ws.wbtlog package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProcessarErroLogResponseProcessarErroLogResult_QNAME = new QName("http://tempuri.org/", "ProcessarErroLogResult");
    private final static QName _ProcessarErroLogSCdOrigem_QNAME = new QName("http://tempuri.org/", "sCdOrigem");
    private final static QName _ProcessarErroLogSDsLogDetalhado_QNAME = new QName("http://tempuri.org/", "sDsLogDetalhado");
    private final static QName _ProcessarErroLogSDsLog_QNAME = new QName("http://tempuri.org/", "sDsLog");
    private final static QName _ProcessarErroLogSNrToken_QNAME = new QName("http://tempuri.org/", "sNrToken");
    private final static QName _ProcessarErrosIntegracaoLogLstIdentificadores_QNAME = new QName("http://tempuri.org/", "lstIdentificadores");
    private final static QName _ProcessarErrosIntegracaoLogResponseProcessarErrosIntegracaoLogResult_QNAME = new QName("http://tempuri.org/", "ProcessarErrosIntegracaoLogResult");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.gov.sp.saobernardo.paradigma.ws.wbtlog
     * 
     */
    ...
    /**
     * Create an instance of {@link ProcessarErroLogResponse }
     * 
     */
    public ProcessarErroLogResponse createProcessarErroLogResponse() {
        return new ProcessarErroLogResponse();
    }
    ...
    /**
     * Create an instance of {@link ProcessarErroLog }
     * 
     */
    public ProcessarErroLog createProcessarErroLog() {
        return new ProcessarErroLog();
    }

    /**
     * Create an instance of {@link ProcessarErrosIntegracaoLog }
     * 
     */
    public ProcessarErrosIntegracaoLog createProcessarErrosIntegracaoLog() {
        return new ProcessarErrosIntegracaoLog();
    }

    /**
     * Create an instance of {@link ProcessarErrosIntegracaoLogResponse }
     * 
     */
    public ProcessarErrosIntegracaoLogResponse createProcessarErrosIntegracaoLogResponse() {
        return new ProcessarErrosIntegracaoLogResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "ProcessarErroLogResult", scope = ProcessarErroLogResponse.class)
    public JAXBElement<RetornoDTO> createProcessarErroLogResponseProcessarErroLogResult(RetornoDTO value) {
        return new JAXBElement<RetornoDTO>(_ProcessarErroLogResponseProcessarErroLogResult_QNAME, RetornoDTO.class, ProcessarErroLogResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "sCdOrigem", scope = ProcessarErroLog.class)
    public JAXBElement<String> createProcessarErroLogSCdOrigem(String value) {
        return new JAXBElement<String>(_ProcessarErroLogSCdOrigem_QNAME, String.class, ProcessarErroLog.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "sDsLogDetalhado", scope = ProcessarErroLog.class)
    public JAXBElement<String> createProcessarErroLogSDsLogDetalhado(String value) {
        return new JAXBElement<String>(_ProcessarErroLogSDsLogDetalhado_QNAME, String.class, ProcessarErroLog.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "sDsLog", scope = ProcessarErroLog.class)
    public JAXBElement<String> createProcessarErroLogSDsLog(String value) {
        return new JAXBElement<String>(_ProcessarErroLogSDsLog_QNAME, String.class, ProcessarErroLog.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "sNrToken", scope = ProcessarErroLog.class)
    public JAXBElement<String> createProcessarErroLogSNrToken(String value) {
        return new JAXBElement<String>(_ProcessarErroLogSNrToken_QNAME, String.class, ProcessarErroLog.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "lstIdentificadores", scope = ProcessarErrosIntegracaoLog.class)
    public JAXBElement<ArrayOfint> createProcessarErrosIntegracaoLogLstIdentificadores(ArrayOfint value) {
        return new JAXBElement<ArrayOfint>(_ProcessarErrosIntegracaoLogLstIdentificadores_QNAME, ArrayOfint.class, ProcessarErrosIntegracaoLog.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "ProcessarErrosIntegracaoLogResult", scope = ProcessarErrosIntegracaoLogResponse.class)
    public JAXBElement<RetornoDTO> createProcessarErrosIntegracaoLogResponseProcessarErrosIntegracaoLogResult(RetornoDTO value) {
        return new JAXBElement<RetornoDTO>(_ProcessarErrosIntegracaoLogResponseProcessarErrosIntegracaoLogResult_QNAME, RetornoDTO.class, ProcessarErrosIntegracaoLogResponse.class, value);
    }

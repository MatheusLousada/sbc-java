 ...
 */
@Deprecated
public class DeParaDadosCertidaoNegFalenciaEConcordata {

	private Map<String, String> mapa;
	@SuppressWarnings("unused")
	private ArquivoDeLog log;

	public DeParaDadosCertidaoNegFalenciaEConcordata(ArquivoDeLog log)   {
		mapa = new HashMap<String, String>();
		mapa.put("DATA7", "dataDeValidade");

		this.log = log;
	}

	public void populaDados(CertidaoNegFalenciaEConcordata de, C7706Bean para)  {
		try {
			...
			for (Map.Entry<String, String> entry : mapa.entrySet()) {
				Class<? extends CertidaoNegFalenciaEConcordata> classe = de.getClass();

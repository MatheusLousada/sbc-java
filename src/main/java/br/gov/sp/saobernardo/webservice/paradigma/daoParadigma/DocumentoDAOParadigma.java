...
public class DocumentoDAOParadigma implements DocumentoDAOInterface {
	...
	public DocumentoDAOParadigma(Connection con, boolean imprimirSQL) {
	...
	public CertidaoNegTributosMunicipaisMobi buscaCertidaoNegTributosMunicipaisMobi(Long codigoWBCEmpresa) throws SQLException {
	...
	public CertidaoNegDebitosTrabalhistas buscaCertidaoNegDebitosTrabalhistas(Long codigoWBCEmpresa) throws SQLException {
	...
	public CertidaoNegFalenciaEConcordata buscaCertidaoNegFalenciaEConcordata(Long codigoWBCEmpresa) throws SQLException {

...
import br.gov.sp.saobernardo.webservice.classes.dao.interfaces.ProdutoPropostaDAOInterface;
...
public class PropostaDAOParadigma implements ProdutoPropostaDAOInterface {

	private DAOExecutor daoEx;

	public PropostaDAOParadigma(Connection con, boolean imprimirSQL) {

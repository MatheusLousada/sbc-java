...
final public class PregaoEletronicoItemPropostaEndpoint extends AbstractEndpointsLicitar {

    public PregaoEletronicoItemPropostaEndpoint(ContextoImportacao contexto) {
        super(contexto);
    }

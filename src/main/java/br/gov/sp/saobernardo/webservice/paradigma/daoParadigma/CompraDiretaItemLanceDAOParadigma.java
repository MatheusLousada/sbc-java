...
public class CompraDiretaItemLanceDAOParadigma implements CompraDiretaItemLanceDAOInterface {

	private DAOExecutor daoEx;

	public CompraDiretaItemLanceDAOParadigma(Connection con, boolean imprimirSQL) {
		daoEx = new DAOExecutor(con, imprimirSQL);
	}

	public List<CompraDiretaItemLanceModel> buscaPeloCodigoDoParadigma(Long codigoWBCCompraDireta, Long codigoWBCItem) throws SQLException {

 ...
 */
@Deprecated
public class DeParaDadosCertidaoNegDebitosTrabalhistas {

	private Map<String, String> mapa;
	@SuppressWarnings("unused")
	private ArquivoDeLog log;

	public DeParaDadosCertidaoNegDebitosTrabalhistas(ArquivoDeLog log)  {
		mapa = new HashMap<String, String>();
		mapa.put("DATA6", "dataDeValidade");

		this.log = log;
	}

	public void populaDados(CertidaoNegDebitosTrabalhistas de, C7706Bean para)  {
		try {
			...
			for (Map.Entry<String, String> entry : mapa.entrySet()) {
				Class<? extends CertidaoNegDebitosTrabalhistas> classe = de.getClass();
